...
$sql="UPDATE `IndividualSignUp` SET `hs_verification_status`='Verified' WHERE Email=	
'$email'";
	...
	if ($hs == "Verified" && $im== "Verified" && $gr== "Verified" && $ex == "Verified") {
		...
		# code...
					...
					echo $iec_number;
		 				...
		 				$sql="UPDATE IndividualSignUp SET IEC_Number=$iec_number WHERE Email='$iec_number'";
